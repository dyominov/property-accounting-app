...
import { setDocumentsOptions, getDocumentsOptionsState } from '@/store/slices/search-slice';

export default function SearchOptionsDialog(props) {
  const { onClose, open } = props;
  const dispatch = useDispatch();
  const searchOptions = useSelector(getDocumentsOptionsState);
