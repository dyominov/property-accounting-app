...
import { addMainAssets, getChangedCategoryMainAssetsState } from '../../../../store/slices/document-changeMainAssetCategory-slice';
...
export default function AddDialog(props) {
  ...
  const selectedProp = useSelector(getChangedCategoryMainAssetsState);
