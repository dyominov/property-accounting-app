...
function DataTableToolbar(props) {
  ...
  const rowsPlural = (numSelected === 1) ? 'основний засіб' : (numSelected >= 2 && numSelected <= 4) ? 'основні засоби' : 'основних засобів';
...
export default function DataTableMainAssets({ rows }) {
                  ...
                  .map((row) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="right">{row.group ? row.group.title : ''}</TableCell>
                        <TableCell align="center">{moment(row.dateOfManufacture).format(DATE_FORMAT)}</TableCell>
                        <TableCell align="center">{moment(row.dateOfStartOperation).format(DATE_FORMAT)}</TableCell>
                        ...
                        <TableCell align="center">{row.aowat}&nbsp;{generalSettings.currency}</TableCell>
                      </StyledTableRow>
                    );
                  })}
              </TableBody>
