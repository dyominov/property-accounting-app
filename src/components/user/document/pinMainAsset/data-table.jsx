...
import { headerColumns } from '@/setupObjects/documents/pinMainAsset/headerColumns';
import { generalSettings } from '@/setupObjects/generalSettings';
import RemoveCircleIcon from '@mui/icons-material/RemoveCircle';

import useFetchGet from '@/hooks/useFetch';
import { getPinnedMainAssetsSelectedDataState, setSelectedPinnedMainAssets, resetSelect } from '@/store/slices/selected-data-slice';
import stableSort from '../../../../utils/stable-sort';
import { getPinnedMainAssetsState, removeMainAsset } from '../../../../store/slices/document-pinMainAsset-slice';
...
export default function DataTable() {
  const pinned = useSelector(getPinnedMainAssetsState);
  const selected = useSelector(getPinnedMainAssetsSelectedDataState);
  const response = useFetchGet(`/api/GET/main-assets-selected`, pinned);
              ...
              <TableBody>
                {stableSort(rows, getComparator(order, orderBy))
                  .map((row, idx) => {
                    ...
                    const labelId = `pin-ma-table-item-${row.id}`;
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="center">
                          <IconButton color="error" aria-label="delete" onClick={() => handleObjectRemove(idx)}>
                            <RemoveCircleIcon />
                          </IconButton>
                        </TableCell>
                      </TableRow>
